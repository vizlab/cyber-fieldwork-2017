...
var DIFFUSION = exports.DIFFUSION = 0;
var CONVECTION = exports.CONVECTION = 1;
var DIFF_CONV = exports.DIFF_CONV = 2;
var LOCK_EXCHANGE = exports.LOCK_EXCHANGE = 3;
...
var _colormap = __webpack_require__(126);
...
var _datatypeConstants = __webpack_require__(124);
...
var renderer = {
    ...
    dataType: _datatypeConstants.DIFFUSION, //0-diffusion 1-convaction 2-convection-diffusion 3-lock-exchange
    D: 20,
    typeFile: [{
    ...
    init: function init() {
        ...
        var typeFile = this.typeFile[this.dataType];
        ...
        var layout = (0, _utils.getLayout)(this.dataType);
        Plotly.relayout('plotlyDiv', layout);

        var fileNames = typeFile.fileNames;

        if (this.dataType === _datatypeConstants.DIFFUSION || this.dataType === _datatypeConstants.DIFF_CONV) {
            fetch(fileNames[0] + this.arrow + 'D' + this.D + '.json').then(function (response) {
                return response.json();
            }).then(function (jsonData) {
                _this.vData['scalar'] = jsonData;
            });
            return fetch(fileNames[1] + this.arrow + 'D' + this.D + '.json').then(function (response) {
                return response.json();
            }).then(function (jsonData) {
        ...
        fetch(fileNames[0] + this.arrow + '.json').then(function (response) {
            return response.json();
        }).then(function (jsonData) {
            _this.vData['scalar'] = jsonData;
        });
        return fetch(fileNames[1] + this.arrow + '.json').then(function (response) {
            return response.json();
        }).then(function (jsonData) {
            _this.vData['gradient'] = jsonData['data'];
            _this.setting['xGrad'] = jsonData['x_grad_max'];
    ...
    //cycle start
    cycleInit: function cycleInit() {
        var _this2 = this;

        renderer.type = 'cycle';
        this.intervalId = setInterval(function () {
            if (_this2.stepId === _this2.vData['scalar'].length) {
                _this2.stepId = 0;
            }
            _this2.printGraph(_this2.stepId);
            (0, _jquery2.default)("#slider-icon").val(_this2.stepId);
            (0, _jquery2.default)("#slider-value").text(_this2.stepId);
            _this2.stepId++;
        }, 500);
    },

    //stop cycle
    cyclePause: function cyclePause() {
    ...
    drawVector: function drawVector(scalarField, gradientField, xGradMax, yGradMax, samplingInterval) {
        ...
        var SCALE = 5;
        var NX = scalarField.length; // NX is number of sampling points of x-axis
        var NY = scalarField[0].length; // NY is number of sampling points of y-axis
    ...
    drawLineWithArrowhead: function drawLineWithArrowhead(p0, p1, headLength, ctx) {
    ...
    //draw 3D graph
    draw3D: function draw3D(vecArray) {
        var data = [{
            z: vecArray,
            type: 'surface',
        ...
        if (this.dataType === _datatypeConstants.LOCK_EXCHANGE) {
            data[0].cmax = 100;
            data[0].cmin = -50;
        }
    ...
    reSetArrow: function reSetArrow() {
        if (this.dataType === _datatypeConstants.CONVECTION || this.dataType === _datatypeConstants.DIFF_CONV) {
            this.arrow = 0;
            (0, _jquery2.default)("#arrows").css('display', 'block');
        } else {
            this.arrow = '';
            (0, _jquery2.default)("#arrows").css('display', 'none');
        }
    },

    changeArrow: function changeArrow(direction) {}
};
...
(0, _jquery2.default)("#auto").on("click", function () {
...
(0, _jquery2.default)("#typeChange input").on("change", _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var datatype;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    datatype = Number((0, _jquery2.default)("input[name='datatype']:checked").val());
...
(0, _jquery2.default)("#diffusionCoeff input").on("change", _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var D;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
            switch (_context3.prev = _context3.next) {
                case 0:
                    D = Number((0, _jquery2.default)("input[name='D']:checked").val());

                    if (!(D !== renderer.D && renderer.dataType !== _datatypeConstants.CONVECTION && renderer.dataType !== _datatypeConstants.LOCK_EXCHANGE)) {
                        _context3.next = 9;
                        break;
                    }
                ...
                case 9:
                    ...
                    if (renderer.dataType === _datatypeConstants.CONVECTION || renderer.dataType === _datatypeConstants.LOCK_EXCHANGE) {
                        renderer.D = D;
                    }
...
(0, _jquery2.default)("#arrows a").on("click", _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var nowArrow;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
            switch (_context4.prev = _context4.next) {
                case 0:
                    nowArrow = (0, _jquery2.default)(this).attr('value');
...
var colorScale = __webpack_require__(127);
var lerp = __webpack_require__(128)
...
var getLayout = exports.getLayout = function getLayout(dataType) {
    var layout = {
        autosize: false,
        width: 500,
        height: 500,
    ...
    if (dataType === _datatypeConstants.LOCK_EXCHANGE) {
