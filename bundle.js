...
var _colormap = __webpack_require__(125);
...
var renderer = {
    ...
    init: function init() {
        ...
        return fetch(fileNames[1]).then(function (response) {
            return response.json();
        }).then(function (jsonData) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    datatype = (0, _jquery2.default)("input[name='datatype']:checked").val();
...
var colorScale = __webpack_require__(126);
var lerp = __webpack_require__(127)
